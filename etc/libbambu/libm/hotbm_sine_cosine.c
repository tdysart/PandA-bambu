/* Copyright (C) 2016-2024 Politecnico di Milano (Italy).
...
__attribute__((always_inline)) static inline unsigned int __shift_left_two_words(unsigned int word1, unsigned int word2,
...
__attribute__((always_inline)) static inline unsigned int __bambu_range_redux(float x_par, unsigned int* global_b_fract,
...
__attribute__((always_inline)) static inline unsigned int hotbm_fsin_or_cos_t1(unsigned char a, unsigned int b,
                                                                               _Bool do_cosine)
{
...
__attribute__((always_inline)) static inline unsigned short int
hotbm_fsin_or_cos_t2(unsigned char a, unsigned short int b, _Bool do_cosine)
{
...
__attribute__((noinline)) static float __fsin_or_cos(unsigned int b_fract, unsigned char exponent,
                                                     unsigned int b_fract_shifted, _Bool do_cosine, _Bool do_negate)
{
   float_uint_converter func_out;
   unsigned int mantissa = b_fract_shifted >> 4;
   unsigned int x = b_fract >> 7;
